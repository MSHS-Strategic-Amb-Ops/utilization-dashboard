...
knitr::include_graphics(readPNG("/nfs/data/Applications/Ambulatory/Mount_Sinai_Logo_H.png"))
```
...
renderReactable({
  ...
  columns = list(
    ...
    avg_vol_Day = colDef(name = "Avg Weekday Volume",
                           headerStyle = list(background = "#221f72", color = "white", fontWeight = "Bold", fontSize = "14px"),
                           # style = list(background = "#EBEBF9")
                           ),
    visits_var_Day = colDef(name = "Variance from Target",
                           headerStyle = list(background = "#221f72", color = "white", fontWeight = "Bold", fontSize = "14px"),
                           # style = list(background = "#EBEBF9"),
                           cell = data_bars(loc_dashboard_tbl, fill_color = c("#ffb3b3","#adebad"), text_position = "outside-end", align_bars = "left")
                           ), 
    visits_util_Day = colDef(name = "% Utilization (By Turns)",
                                    headerStyle = list(background = "#221f72", color = "white", fontWeight = "Bold", fontSize = "14px"),
                                    format = colFormat(percent = TRUE, digits = 0),
                                    style = function(value) {
                                      if(!is.numeric(value)) return()
                                     normalized <- (value - min(loc_dashboard_tbl$visits_util_Day, na.rm = TRUE))/
                                       (max(loc_dashboard_tbl$visits_util_Day, na.rm = TRUE) - 
                                          min(loc_dashboard_tbl$visits_util_Day, na.rm = TRUE))
                                      color <- RdYlGrn(normalized)
                                      list(background = color,
                                           fontSize = "14px",
                                           fontWeight = "Bold")}),
    dur_util_Day = colDef(name = "% Utilization (By Duration)",
                                 headerStyle = list(background = "#221f72", color = "white", fontWeight = "Bold", fontSize = "14px"),
                                 format = colFormat(percent = TRUE),
                                  style = function(value) {
                                    if(!is.numeric(value)) return()
                                     normalized <- (value - min(loc_dashboard_tbl$dur_util_Day, na.rm = TRUE))/
                                       (max(loc_dashboard_tbl$dur_util_Day, na.rm = TRUE) - 
                                          min(loc_dashboard_tbl$dur_util_Day, na.rm = TRUE))
                                      color <- RdYlGrn(normalized)
                                      list(background = color,
                                           fontSize = "14px",
                                           fontWeight = "Bold")}),
    avg_vol_AM = colDef(name = "Avg Weekday Volume",
                           headerStyle = list(background = "#d80b8c", color = "white", fontWeight = "Bold", fontSize = "14px"),
                           # style = list(background = "#EBEBF9")
                           ),
    visits_var_AM = colDef(name = "Variance from Target",
                           headerStyle = list(background = "#d80b8c", color = "white", fontWeight = "Bold", fontSize = "14px"),
                           # style = list(background = "#EBEBF9"),
                           cell = data_bars(loc_dashboard_tbl, fill_color = c("#ffb3b3","#adebad"), text_position = "outside-end", align_bars = "left")
                           ), 
    visits_util_AM = colDef(name = "% Utilization (By Turns)",
                                    headerStyle = list(background = "#d80b8c", color = "white", fontWeight = "Bold", fontSize = "14px"),
                                    format = colFormat(percent = TRUE, digits = 0),
                                    style = function(value) {
                                      if(!is.numeric(value)) return()
                                     normalized <- (value - min(loc_dashboard_tbl$visits_util_AM, na.rm = TRUE))/
                                       (max(loc_dashboard_tbl$visits_util_AM, na.rm = TRUE) - 
                                          min(loc_dashboard_tbl$visits_util_AM, na.rm = TRUE))
                                      color <- RdYlGrn(normalized)
                                      list(background = color,
                                           fontSize = "14px",
                                           fontWeight = "Bold")}),
    dur_util_AM = colDef(name = "% Utilization (By Duration)",
                                 headerStyle = list(background = "#d80b8c", color = "white", fontWeight = "Bold", fontSize = "14px"),
                                 format = colFormat(percent = TRUE),
                                  style = function(value) {
                                    if(!is.numeric(value)) return()
                                     normalized <- (value - min(loc_dashboard_tbl$dur_util_AM, na.rm = TRUE))/
                                       (max(loc_dashboard_tbl$dur_util_AM, na.rm = TRUE) - 
                                          min(loc_dashboard_tbl$dur_util_AM, na.rm = TRUE))
                                      color <- RdYlGrn(normalized)
                                      list(background = color,
                                           fontSize = "14px",
                                           fontWeight = "Bold")}),
    avg_vol_PM = colDef(name = "Avg Weekday Volume",
                           headerStyle = list(background = "#00aeef", color = "white", fontWeight = "Bold", fontSize = "14px"),
                           # style = list(background = "#EBEBF9")
                           ),
    visits_var_PM = colDef(name = "Variance from Target",
                           headerStyle = list(background = "#00aeef", color = "white", fontWeight = "Bold", fontSize = "14px"),
                           # style = list(background = "#EBEBF9"),
                           cell = data_bars(loc_dashboard_tbl, fill_color = c("#ffb3b3","#adebad"), text_position = "outside-end", align_bars = "left")
                           ), 
    visits_util_PM = colDef(name = "% Utilization (By Turns)",
                                    headerStyle = list(background = "#00aeef", color = "white", fontWeight = "Bold", fontSize = "14px"),
                                    format = colFormat(percent = TRUE, digits = 0),
                                    style = function(value) {
                                      if(!is.numeric(value)) return()
                                     normalized <- (value - min(loc_dashboard_tbl$visits_util_PM, na.rm = TRUE))/
                                       (max(loc_dashboard_tbl$visits_util_PM, na.rm = TRUE) - 
                                          min(loc_dashboard_tbl$visits_util_PM, na.rm = TRUE))
                                      color <- RdYlGrn(normalized)
                                      list(background = color,
                                           fontSize = "14px",
                                           fontWeight = "Bold")}),
    dur_util_PM = colDef(name = "% Utilization (By Duration)",
                                 headerStyle = list(background = "#00aeef", color = "white", fontWeight = "Bold", fontSize = "14px"),
                                 format = colFormat(percent = TRUE),
                                  style = function(value) {
                                    if(!is.numeric(value)) return()
                                     normalized <- (value - min(loc_dashboard_tbl$dur_util_PM, na.rm = TRUE))/
                                       (max(loc_dashboard_tbl$dur_util_PM, na.rm = TRUE) - 
                                          min(loc_dashboard_tbl$dur_util_PM, na.rm = TRUE))
                                      color <- RdYlGrn(normalized)
                                      list(background = color,
                                           fontSize = "14px",
                                           fontWeight = "Bold")})
...
renderReactable({
  ...
  # data <- provUtilSummary() 
    # mutate(visits_var = avg_vol - (total_rooms*Benchmark),
    #        visits_util = round(avg_vol/(total_rooms*Benchmark),2),
    #        dur_util = ifelse(Session == "Day", round(avg_dur/(total_rooms*8*60),2),
    #                          round(avg_dur/(total_rooms*4*60),2)))
  ...
  prov_dashboard_tbl <- provUtilSummary() %>%
    dplyr::select(-c("Appt.YearQtr","avg_dur","Visit.Method")) %>%
    arrange(factor(Session, levels = c("Day","AM","PM"))) %>%
  ...
  columns = list(
    ...
    visits_var_Day = colDef(name = "Variance from Target",
                           headerStyle = list(background = "#221f72", color = "white", fontWeight = "Bold", fontSize = "14px"),
                           # style = list(background = "#EBEBF9"),
                           cell = data_bars(prov_dashboard_tbl, fill_color = c("#ffb3b3","#adebad"), text_position = "outside-end", align_bars = "left")
                           ), 
    visits_util_Day = colDef(name = "% Utilization (By Turns)",
                                    headerStyle = list(background = "#221f72", color = "white", fontWeight = "Bold", fontSize = "14px"),
                                    format = colFormat(percent = TRUE, digits = 0),
                                    style = function(value) {
                                      if(!is.numeric(value)) return()
                                     normalized <- (value - min(prov_dashboard_tbl$visits_util_Day, na.rm = TRUE))/
                                       (max(prov_dashboard_tbl$visits_util_Day, na.rm = TRUE) - 
                                          min(prov_dashboard_tbl$visits_util_Day, na.rm = TRUE))
                                      color <- RdYlGrn(normalized)
                                      list(background = color,
                                           fontSize = "14px",
                                           fontWeight = "Bold")}),
    dur_util_Day = colDef(name = "% Utilization (By Duration)",
                                 ...
                                 format = colFormat(percent = TRUE),
                                  style = function(value) {
                                    if(!is.numeric(value)) return()
                                     normalized <- (value - min(prov_dashboard_tbl$dur_util_Day, na.rm = TRUE))/
                                       (max(prov_dashboard_tbl$dur_util_Day, na.rm = TRUE) - 
                                          min(prov_dashboard_tbl$dur_util_Day, na.rm = TRUE))
                                      color <- RdYlGrn(normalized)
                                      list(background = color,
                                           fontSize = "14px",
                                           fontWeight = "Bold")}),
    ...
    visits_util_AM = colDef(name = "% Utilization (By Turns)",
                                    ...
                                    style = function(value) {
                                      if(!is.numeric(value)) return()
                                     normalized <- (value - min(prov_dashboard_tbl$visits_util_AM, na.rm = TRUE))/
                                       (max(prov_dashboard_tbl$visits_util_AM, na.rm = TRUE) - 
                                          min(prov_dashboard_tbl$visits_util_AM, na.rm = TRUE))
                                      color <- RdYlGrn(normalized)
                                      list(background = color,
                                           fontSize = "14px",
                                           fontWeight = "Bold")}),
    dur_util_AM = colDef(name = "% Utilization (By Duration)",
                                 ...
                                 format = colFormat(percent = TRUE),
                                  style = function(value) {
                                    if(!is.numeric(value)) return()
                                     normalized <- (value - min(prov_dashboard_tbl$dur_util_AM, na.rm = TRUE))/
                                       (max(prov_dashboard_tbl$dur_util_AM, na.rm = TRUE) - 
                                          min(prov_dashboard_tbl$dur_util_AM, na.rm = TRUE))
                                      color <- RdYlGrn(normalized)
                                      list(background = color,
                                           fontSize = "14px",
                                           fontWeight = "Bold")}),
    ...
    visits_util_PM = colDef(name = "% Utilization (By Turns)",
                                    ...
                                    format = colFormat(percent = TRUE, digits = 0),
                                    style = function(value) {
                                      if(!is.numeric(value)) return(list(background = "black"))
                                     normalized <- (value - min(prov_dashboard_tbl$visits_util_PM, na.rm = TRUE))/
                                       (max(prov_dashboard_tbl$visits_util_PM, na.rm = TRUE) - 
                                          min(prov_dashboard_tbl$visits_util_PM, na.rm = TRUE))
                                      color <- RdYlGrn(normalized)
                                      list(background = color,
                                           fontSize = "14px",
                                           fontWeight = "Bold")}),
    dur_util_PM = colDef(name = "% Utilization (By Duration)",
                                 ...
                                 format = colFormat(percent = TRUE),
                                  style = function(value) {
                                    if(value == 0) return(list(background = "black"))
                                     normalized <- (value - min(prov_dashboard_tbl$dur_util_PM, na.rm = TRUE))/
                                       (max(prov_dashboard_tbl$dur_util_PM, na.rm = TRUE) - 
                                          min(prov_dashboard_tbl$dur_util_PM, na.rm = TRUE))
                                      color <- RdYlGrn(normalized)
                                      list(background = color,
                                           fontSize = "14px",
                                           fontWeight = "Bold")})
